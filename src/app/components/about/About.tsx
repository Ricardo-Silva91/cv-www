...
export default function About() {
  ...
  return (
    <div
      id="about"
      className={`${styles.about} section reveal-box ${
      ...
      <div className={styles.about__info}>
        ...
        >
          <p>
            ...
            and playwright scripts have been my best friends.
          </p>
          <p className="mt-6">
            My prefered tool for web development is React but i&apos;m familiar
            with Vue, Angular and Svelte.
          </p>
        </div>
      </div>
    </div>
